...
class Application:
        ...
        for frameelement in [a for a in frameelements if a["frame"] == framedigitado]:
            if framedigitado == frameelement["frame"]:
                ...
                self.mensagem["text"] = ("O frame %s evoca os seguintes ítens lexicais. \n "
                                         "Para cada um deles informe se é verbo (v), substantivo (n), adjetivo (a), num, adv ou prep:" % framedigitado)

                itens = []
                for e in frameelement["itens"]:
                    itens.append(str(e))

                self.lista_aleatoria_itens_lexicais = random.sample(itens, 4)

                self.iten1Label = Label(self.quintoContainer, text="%s: " % self.lista_aleatoria_itens_lexicais[0],
                ...
                self.iten2Label = Label(self.sextoContainer, text="%s: " % self.lista_aleatoria_itens_lexicais[1],
                                        font=self.fontePadrao)
                ...
                self.iten3Label = Label(self.setimoContainer, text="%s: " % self.lista_aleatoria_itens_lexicais[2],
                                        font=self.fontePadrao)
                ...
                self.iten4Label = Label(self.oitavoContainer, text="%s: " % self.lista_aleatoria_itens_lexicais[3],
                                        font=self.fontePadrao)
    ...
    def verificaTipo(self):
        ...
        for frameelement in [a for a in frameelements if a["frame"] == frame]:
            if frameelement["itens"][self.lista_aleatoria_itens_lexicais[0]] == til1:
                self.mensagem = Label(self.nonoContainer, text="", font=self.fontePadrao, foreground='green')
                self.mensagem.pack()
                self.mensagem["text"] = "Correto! O item lexical %s é um %s" % (
                self.lista_aleatoria_itens_lexicais[0], til1)
            if frameelement["itens"][self.lista_aleatoria_itens_lexicais[0]] != til1:
                ...
                self.mensagem["text"] = "Errado! O item lexial %s não é um %s e sim um %s" % (
                    self.lista_aleatoria_itens_lexicais[0], til1,
                    frameelement["itens"][self.lista_aleatoria_itens_lexicais[0]])

            if frameelement["itens"][self.lista_aleatoria_itens_lexicais[1]] == til2:
                self.mensagem = Label(self.nonoContainer, text="", font=self.fontePadrao, foreground='green')
                self.mensagem.pack()
                self.mensagem["text"] = "Correto! O item lexical %s é um %s" % (
                self.lista_aleatoria_itens_lexicais[1], til2)
            if frameelement["itens"][self.lista_aleatoria_itens_lexicais[1]] != til2:
                self.mensagem = Label(self.nonoContainer, text="", font=self.fontePadrao, foreground='red')
                self.mensagem.pack()
                self.mensagem["text"] = "Errado! O item lexical %s não é um %s e sim um %s" % (
                    self.lista_aleatoria_itens_lexicais[1], til2,
                    frameelement["itens"][self.lista_aleatoria_itens_lexicais[1]])

            if frameelement["itens"][self.lista_aleatoria_itens_lexicais[2]] == til3:
                self.mensagem = Label(self.nonoContainer, text="", font=self.fontePadrao, foreground='green')
                self.mensagem.pack()
                self.mensagem["text"] = "Correto! O item lexical %s é um %s" % (
                self.lista_aleatoria_itens_lexicais[2], til3)
            if frameelement["itens"][self.lista_aleatoria_itens_lexicais[2]] != til3:
                self.mensagem = Label(self.nonoContainer, text="", font=self.fontePadrao, foreground='red')
                self.mensagem.pack()
                self.mensagem["text"] = "Errado! O item lexical %s não é um %s e sim um %s" % (
                    self.lista_aleatoria_itens_lexicais[2], til3,
                    frameelement["itens"][self.lista_aleatoria_itens_lexicais[2]])

            if frameelement["itens"][self.lista_aleatoria_itens_lexicais[3]] == til4:
                self.mensagem = Label(self.nonoContainer, text="", font=self.fontePadrao, foreground='green')
                self.mensagem.pack()
                self.mensagem["text"] = "Correto! O item lexical %s é um %s" % (
                self.lista_aleatoria_itens_lexicais[3], til4)
            if frameelement["itens"][self.lista_aleatoria_itens_lexicais[3]] != til4:
                self.mensagem = Label(self.nonoContainer, text="", font=self.fontePadrao, foreground='red')
                self.mensagem.pack()
                self.mensagem["text"] = "Errado! O item lexical %s não é um %s e sim um %s" % (
                    self.lista_aleatoria_itens_lexicais[3], til4,
                    frameelement["itens"][self.lista_aleatoria_itens_lexicais[3]])
